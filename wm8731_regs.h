...
#define WM_REG_AN_PATH_ADDR                                        0x04 /* analog audio path control */
...
/* LEFT_OUT Register Fields */
    /* LEFT_OUT -> LEFT_OUT */
    #define WM_LEFT_OUT_LEFT_OUT_FIELD_MASK                        0xFFFF /* Left Headphone Out control */
    #define WM_LEFT_OUT_LEFT_OUT_FIELD_OFFSET                      0x0000

/* RIGHT_OUT Register Fields */
    /* RIGHT_OUT -> RIGHT_OUT */
    #define WM_RIGHT_OUT_RIGHT_OUT_FIELD_MASK                      0xFFFF /* Right Headphone Out control */
    #define WM_RIGHT_OUT_RIGHT_OUT_FIELD_OFFSET                    0x0000
...
/* SAMPLE Register Fields */
    /* SAMPLE -> SAMPLE */
    #define WM_SAMPLE_SAMPLE_FIELD_MASK                            0xFFFF /* Sampling control */
    #define WM_SAMPLE_SAMPLE_FIELD_OFFSET                          0x0000
...
/**
 * @brief writes the LEFT_OUT field to the LEFT_OUT register 
 * @param dev ptr to wm8731 device
 */
#define wm_set_left_out(dev, val) regdev_write_field(&(dev)->mRegDev, &(dev)->mLeftOut, WM_LEFT_OUT_LEFT_OUT_FIELD_MASK , (val) )
/**
 * @brief writes the RIGHT_OUT field to the RIGHT_OUT register 
 * @param dev ptr to wm8731 device
 */
#define wm_set_right_out(dev, val) regdev_write_field(&(dev)->mRegDev, &(dev)->mRightOut, WM_RIGHT_OUT_RIGHT_OUT_FIELD_MASK , (val) )
/**
...
/**
 * @brief writes the SAMPLE field to the SAMPLE register 
 * @param dev ptr to wm8731 device
 */
#define wm_set_sample(dev, val) regdev_write_field(&(dev)->mRegDev, &(dev)->mSample, WM_SAMPLE_SAMPLE_FIELD_MASK , (val) )
/**
